...
class ExpenseLineForm(ModelForm):
  ...
  begin_at_date = forms.DateField(label=ugettext_lazy('Begin at date'), widget=DateInput(attrs={'placeholder':ugettext_lazy('DD.MM.YYYY'), 'class':'short-input begin_at_date'}),
  ...
  ended_at_date = forms.DateField(label=ugettext_lazy('Ended at date'),
    input_formats=('%d.%m.%Y',),
    required=False, widget=DateInput(attrs={'placeholder':ugettext_lazy('DD.MM.YYYY'), 'class':'hidden-start short-input ended_at_date'}))
